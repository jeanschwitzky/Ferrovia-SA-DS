...
$codigo = $_GET['codigo'] ?? '';
$stmt = $conn->prepare("SELECT * FROM notificacoes WHERE pk_notificacao = ?");
...
<body>
    ...
    <form action="editar_notificacoes.php" method="POST"
        onsubmit="return confirm('Deseja realmente salvar as alterações?')">

        <input type="hidden" name="pk_notificacao" value="<?php echo $notificacao["pk_notificacao"]; ?>">

        <div class="linha-campo">
            <i class="bi bi-card-heading"></i>
            <input type="text" name="nome_notificacao" required 
                value="<?php echo $notificacao["nome_notificacao"]; ?>" />
        </div>

        <div class="linha-campo">
            <i class="bi bi-geo-alt-fill"></i>
            <input type="text" name="localizacao_notificacao" required 
                value="<?php echo $notificacao["localizacao_notificacao"]; ?>" />
        </div>

        <div class="linha-campo">
            <i class="bi bi-exclamation-triangle-fill"></i>
            <input type="text" name="problema_notificacao" required 
                value="<?php echo $notificacao["problema_notificacao"]; ?>" />
        </div>

        <div class="linha-campo">
            <i class="bi bi-calendar-check-fill"></i>
            <input type="date" name="data_notificacao" required
                value="<?php echo $notificacao["data_notificacao"]; ?>" />
        </div>

        <div class="linha-campo">
            <i class="bi bi-alarm"></i>
            <input type="time" name="hora_notificacao" required
                value="<?php echo $notificacao["hora_notificacao"]; ?>" />
        </div>
        ...
        <div class="linha-campo_botao">
            ...
            <a href="notificacoes.php"><input class ="botao_excluir" type="button" value="Cancelar"></a>
            </div>
