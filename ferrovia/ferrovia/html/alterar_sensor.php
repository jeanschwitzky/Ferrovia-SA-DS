...
$codigo = $_GET['codigo'] ?? '';
$stmt = $conn->prepare("SELECT * FROM sensores WHERE pk_sensor = ?");
    ...
    <main>
        <section class="conteudo">
            <form action="editar_sensor.php" method="POST"
                ...
                <input type="hidden" name="pk_sensor" value="<?php echo $sensor["pk_sensor"]; ?>">

                <div class="linha-campo">
                    <i class="bi bi-bullseye"></i>
                    <input type="text" name="tipo_sensor" required value="<?php echo $sensor["tipo_sensor"]; ?>" />
                </div>

                <div class="linha-campo">
                    <i class="bi bi-geo-alt-fill"></i>
                    <input type="text" name="localizacao_sensor" required
                        value="<?php echo $sensor["localizacao_sensor"]; ?>" />
                </div>

                <div class="linha-campo">
                    <i class="bi bi-clock-history"></i>
                    <select name="status_sensor" required value="<?php echo $sensor["status_sensor"]; ?>">
                ...
                <div class="linha-campo">
                    ...
                    <input type="date" name="data_instalacao" value="<?php echo $sensor["data_instalacao"]; ?>" />
                </div>
                ...
                <div class="linha-campo_botao">
                    ...
                    <div class="botao_cancelar">
                        <a href="sensores.php"><input class="botao_excluir" type="button" value="Cancelar"></a>
                    </div>
