...
<head>
    ...
    <title>Ferrovia - Gerenciamento de Trens</title>
...
<body>
    ...
    <main>
        <section class="conteudo">
            <form id="tremForm" action="cadastrar_trem.php" method="POST" style="display: none;">
                ...
                <div class="form-group">
                    ...
                    <textarea name="observacoes_trem" placeholder="Informações adicionais..."></textarea>
                </div>
